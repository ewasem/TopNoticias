...
import br.com.ewapps.newsapp.MainApp
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val _getSearchedArticle = MutableStateFlow(TopNewsResponse())
    val getSearchedArticle: StateFlow<TopNewsResponse>
        get() = _getSearchedArticle
